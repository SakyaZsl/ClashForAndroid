...
import com.github.kr328.clash.common.network.http.back.OptionalExecutor;
import com.github.kr328.clash.common.network.http.utils.NetWorkUtil;
...
public final class CompletableCallAdapterFactory extends CallAdapter.Factory {
    ...
    public CallAdapter<?, ?> get(@NonNull Type returnType, @NonNull Annotation[] annotations, @NonNull Retrofit retrofit) {
        ...
        final Executor executor = NetWorkUtil.isAnnotationPresent(annotations, SkipCallbackExecutor.class)
                ? null
